        ...
        <footer className="bg-grayBackground text-light">
            <div className="container">
                <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-5">
                    <div className="text-center w-64 mx-auto flex md:block flex-col items-center justify-center">
                        <Logo />
                    ...
                    <div className="text-center sm:text-left md:ps-8">
                ...
                <div className="mb-6 sm:flex sm:items-center sm:justify-between">
                    <div className="lg:flex justify-between items-center">
                        ...
                        <ul className="mt-4 md:mt-0 ms-8  text-sm flex items-center justify-center gap-4 ">
                            <li>
                                <Link className="text-primary transition hover:text-light underline" href="/imprint">Impressum</Link>
                            </li>
                            <li>
                                <Link className="text-primary transition hover:text-light underline " href="/privacy-policy">Datenschutz</Link>
                            </li>
                        </ul>
                    </div>
